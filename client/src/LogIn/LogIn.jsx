  ...
  return (
    ...
    <div className="login_body">
        ...
        <div className="v_box">
            ...
            <div className='OAuth'>
                    <a className='login_google' href='https://ammuse.store/oauth2/authorization/google?redirect_uri=http://amuse-travel-client.s3-website.ap-northeast-2.amazonaws.com/'>
                        <GoogleIcon sx={{mr: 4}}/>
                        Google 로그인
                    </a>
                    <a className='login_naver' href='https://ammuse.store/oauth2/authorization/naver?redirect_uri=http://amuse-travel-client.s3-website.ap-northeast-2.amazonaws.com/'>
                        <img src='data:image/png;base64,'
                        alt='네이버 로고'
                        className='naver_logo' />
                        Naver 로그인
                    </a>
                    <a className='login_kakao' href='https://ammuse.store/oauth2/authorization/kakao?redirect_uri=http://amuse-travel-client.s3-website.ap-northeast-2.amazonaws.com/'>
                        <img

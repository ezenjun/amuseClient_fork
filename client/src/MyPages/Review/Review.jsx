...
export default function Review() {
  ...
  useEffect(() => {
    axios.get(`https://vikrant.store/detail/${id}/picture`).then((res) => {
      console.log(res);
      setReviewItemImg(res.data.data.pictures[0]);
    });
    axios.get(`https://vikrant.store/detail/${id}/title`).then((res) => {
      console.log(res);
  ...
  const submitRating = () => {
    ...
    // 리뷰 post 요청하기
    axios.post(`https://vikrant.store/my-page/item/${id}/review`, data, config).then((res) => console.log(res));
  };
